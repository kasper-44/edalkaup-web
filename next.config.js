...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Old WP car listings were 404 or dumping onto empty /afhent
      { source: '/listing/:slug*', destination: '/bilar', permanent: true },
      { source: '/category/auto', destination: '/bilar', permanent: true },
      { source: '/category/:slug*', destination: '/bilar', permanent: true },
      { source: '/how-to-select-a-local-dealer-for-new-used-car', destination: '/um-okkur', permanent: true },
