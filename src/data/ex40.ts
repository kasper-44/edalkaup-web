...
export const ex40Cars: EX40Car[] = [
  ...
  { id: 'ex40-004', config: 'Twin Motor Performance', price: 7690000, exteriorColor: 'Crystal White', interiorColor: 'Charcoal Wool Blend', packages: ['Climate Pack', 'Lounge Pack'], status: 'available', deliveryEstimate: 'Ágúst 2026', image: '/images/ex40/crystal-white.jpg' },
  { id: 'ex40-005', config: 'Single Motor Extended Range', price: 7690000, exteriorColor: 'Vapour Grey', interiorColor: 'Blond Nappa Leather', packages: ['Climate Pack', 'Park Assist Pack', 'Harman Kardon'], status: 'available', deliveryEstimate: 'Ágúst 2026', image: '/images/ex40/vapour-grey.jpg' },
  ...
  { id: 'ex40-007', config: 'Single Motor Extended Range', price: 7690000, exteriorColor: 'Onyx Black', interiorColor: 'Charcoal Nappa Leather', packages: ['Climate Pack', 'Park Assist Pack'], status: 'available', deliveryEstimate: 'Ágúst 2026', image: '/images/ex40/onyx-black.jpg' },
  ...
  { id: 'ex40-011', config: 'Single Motor Extended Range', price: 7690000, exteriorColor: 'Crystal White', interiorColor: 'Blond Wool Blend', packages: ['Climate Pack', 'Harman Kardon'], status: 'available', deliveryEstimate: 'Ágúst 2026', image: '/images/ex40/crystal-white.jpg' },
  { id: 'ex40-012', config: 'Twin Motor Performance', price: 7690000, exteriorColor: 'Vapour Grey', interiorColor: 'Charcoal Wool Blend', packages: ['Lounge Pack', 'Park Assist Pack'], status: 'available', deliveryEstimate: 'Ágúst 2026', image: '/images/ex40/vapour-grey.jpg' },
  ...
  { id: 'ex40-014', config: 'Twin Motor Performance', price: 7690000, exteriorColor: 'Onyx Black', interiorColor: 'Charcoal Nappa Leather', packages: ['Climate Pack', 'Park Assist Pack', 'Harman Kardon'], status: 'available', deliveryEstimate: 'Ágúst 2026', image: '/images/ex40/onyx-black.jpg' },
  ...
  { id: 'ex40-018', config: 'Twin Motor Performance', price: 7690000, exteriorColor: 'Crystal White', interiorColor: 'Charcoal Nappa Leather', packages: ['Climate Pack', 'Park Assist Pack'], status: 'available', deliveryEstimate: 'Ágúst 2026', image: '/images/ex40/crystal-white.jpg' },
  { id: 'ex40-019', config: 'Single Motor Extended Range', price: 7690000, exteriorColor: 'Vapour Grey', interiorColor: 'Charcoal Wool Blend', packages: ['Lounge Pack', 'Bowers & Wilkins'], status: 'available', deliveryEstimate: 'Ágúst 2026', image: '/images/ex40/vapour-grey.jpg' },
