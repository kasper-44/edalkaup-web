    ...
    <div className="pt-20 lg:pt-24">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            <h2 className="text-2xl font-bold text-white mb-6">Af hverju Eðalkaup?</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold text-white mb-6">Hvers vegna velja okkur?</h2>
            <div className="space-y-4">
              {[
                ...
                <div key={item.title} className="flex gap-4 p-4 bg-navy-800 rounded-xl border border-white/5">
      ...
      <section className="bg-navy-800/50 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white">Hvernig innflutningurinn virkar</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {steps.map((step) => (
              <div key={step.num} className="relative p-6 bg-navy-800 rounded-2xl border border-white/5">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-gradient-to-r from-accent/10 to-accent/5 rounded-3xl border border-accent/20 p-10 sm:p-16">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Úranus ehf.</h2>
