    ...
    <div className="pt-20 lg:pt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-white">Afhentir bílar</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {deliveredCars.map((car) => (
            <article key={car.id} className="bg-navy-800 rounded-2xl overflow-hidden border border-white/5">
              ...
              <div className="p-5">
                ...
                <h3 className="text-lg font-bold text-white mt-1">{getCarTitle(car)}</h3>
                ...
                <p className="mt-3 text-lg font-bold text-white/60 line-through">{formatPrice(car.price)}</p>
              </div>
            </article>
          ))}
        </div>
        ...
        {/* Social proof */}
        <div className="mt-16 text-center bg-navy-800/50 rounded-3xl border border-white/5 p-10 sm:p-16">
          <p className="text-5xl font-bold text-accent mb-4">500+</p>
          <p className="text-xl text-white font-semibold mb-2">Bílar afhentir til viðskiptavina</p>
