...
import { ex60Cars, formatEX60Price, colorHex } from '@/data/ex60'
...
export default function VolvoEX60Page() {
  return (
    <>
      {/* ─── Hero ─── */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                ...
                <div className="bg-white dark:bg-navy-700/60 rounded-xl border border-black/5 dark:border-white/5 px-5 py-3 text-center">
                  <p className="text-2xl font-bold text-accent">800+ km</p>
              ...
              <p className="text-3xl font-bold text-gray-900 dark:text-white">Frá {formatEX60Price(12390000)}</p>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">{ex60Cars.length} bílar í boði</h2>
        </div>
          ...
          {ex60Cars.map((car) => (
            ...
            >
              <div className="relative aspect-[16/10] overflow-hidden">
                <Image src={car.image} alt={`Volvo EX60 — ${car.exteriorColor}`} fill className="object-cover group-hover:scale-105 transition-transform duration-500" sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 25vw" />
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <h3 className="text-base font-bold text-gray-900 dark:text-white mt-0.5 mb-1">EX60 P12 Long Range</h3>
                ...
                <div className="pt-3 border-t border-black/5 dark:border-white/5 flex items-end justify-between">
                  <p className="text-xl font-bold text-gray-900 dark:text-white">{formatEX60Price(car.price)}</p>
                  {car.status !== 'sold' && (
        ...
        <div className="relative bg-gradient-to-r from-accent/10 to-accent/5 rounded-3xl border border-accent/20 p-10 sm:p-16 text-center overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-gray-600 dark:text-slate-300 max-w-xl mx-auto mb-8">
              Hafðu samband og við aðstoðum þig við að velja réttan EX60 P12 Long Range. Einnig hægt að panta sérsniðna útgáfu.
            </p>
